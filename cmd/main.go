...
import (
	...
	nfszdevv1alpha1 "github.com/rybo/nfsZ/api/v1alpha1"
	"github.com/rybo/nfsZ/internal/controller"
...
func init() {
	...
	utilruntime.Must(nfszdevv1alpha1.AddToScheme(scheme))
...
func main() {
	...
	var ganeshaImage string
	var tlsOpts []func(*tls.Config)
	flag.StringVar(&operatorNamespace, "operator-namespace",
		envOr("OPERATOR_NAMESPACE", "nfsz-system"),
		"Namespace hosting the per-SharedVolume NFS server stacks.")
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "8d61f1dc.nfsz.dev",
